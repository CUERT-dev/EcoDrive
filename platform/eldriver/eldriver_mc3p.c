...
void eldriver_mc3p_write_phase_duty(eldriver_mc3p_handle_t *h, uint16_t dutyu_q15, uint16_t dutyv_q15, uint16_t dutyw_q15)
{
...
static const mc3p_adc_map_t adc_trap_table[6] = {
    [ELDRIVER_MC3P_SECTOR_TRAP1 - 1] = { ELDRIVER_MC3P_VSW_ADC_CHANNEL, ELDRIVER_MC3P_CSV_ADC_CHANNEL },
    [ELDRIVER_MC3P_SECTOR_TRAP2 - 1] = { ELDRIVER_MC3P_VSV_ADC_CHANNEL, ELDRIVER_MC3P_CSW_ADC_CHANNEL },
    [ELDRIVER_MC3P_SECTOR_TRAP3 - 1] = { ELDRIVER_MC3P_VSU_ADC_CHANNEL, ELDRIVER_MC3P_CSW_ADC_CHANNEL },
    [ELDRIVER_MC3P_SECTOR_TRAP4 - 1] = { ELDRIVER_MC3P_VSW_ADC_CHANNEL, ELDRIVER_MC3P_CSU_ADC_CHANNEL },
    [ELDRIVER_MC3P_SECTOR_TRAP5 - 1] = { ELDRIVER_MC3P_VSV_ADC_CHANNEL, ELDRIVER_MC3P_CSU_ADC_CHANNEL },
    [ELDRIVER_MC3P_SECTOR_TRAP6 - 1] = { ELDRIVER_MC3P_VSU_ADC_CHANNEL, ELDRIVER_MC3P_CSV_ADC_CHANNEL },
};
...
void eldriver_mc3p_read_sync(eldriver_mc3p_handle_t *h, void* data)
{
    ...
    if(is_svm)
    {
        ((eldriver_mc3p_svm_data_t *)(data))->vbus_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_1)));
        ((eldriver_mc3p_svm_data_t *)(data))->cu_q31= (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_2)));
        ((eldriver_mc3p_svm_data_t *)(data))->cv_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_3)));  
        ((eldriver_mc3p_svm_data_t *)(data))->cw_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_4)));        
    }
    else if (is_trap)
    {
        ((eldriver_mc3p_trap_data_t *)(data))->vbus_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_1)));
        ((eldriver_mc3p_trap_data_t *)(data))->vbemf_q31 = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_2)));
        ((eldriver_mc3p_trap_data_t *)(data))->cbus_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_3)));
    }
    else{
        ((eldriver_mc3p_trap_data_t *)(data))->vbus_q31  = (h->adc_to_uV * (LL_ADC_INJ_ReadConversionData12(ADC1, LL_ADC_INJ_RANK_1)));
    }
